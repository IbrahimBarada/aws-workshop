...
class Node:
    def __init__(self):
        self.host = '172.31.86.21'  # Server local private ip
        self.port = 4000
        self.name = 'Node_1'
        self.s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        self.s.bind((self.host, self.port))
        self.nodes = [
            ('Node_2', '54.208.113.84', 4000),
            ('Node_3', '54.173.115.254', 4000),
            ('Node_4', '3.86.151.229', 4000),
        ]
    ...
    def send(self):
        ...
        if create_event(msg_send):
            msg = str(self.host) + ", " + str(self.port) + ": " + msg_send + "\n"
            self.log(msg)
